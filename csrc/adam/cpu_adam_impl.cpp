                            ...
                            float new_avg_sq_scaling)
{
    ...
    // std::cout << "Step 1 -> avg_scaling: " << avg_scaling << ", avg_sq_scaling: " << avg_sq_scaling << ", new_avg_scaling: " << new_avg_scaling << ", new_avg_sq_scaling: " << new_avg_sq_scaling << std::endl;
    ...
    // std::cout << "Step 1[AVX] -> ret: " << ret.first << ", " << ret.second << std::endl;
#endif
...
#pragma omp for
    ...
    // std::cout << "Step 1 [Final] -> ret: " << ret.first << ", " << ret.second << std::endl;
    return ret;
}
                            ...
                            float new_avg_sq_scaling)
{
    size_t rounded_size = 0;
    std::pair<float, float> ret = std::make_pair(0.0f, 0.0f);
    // std::cout << "Step->4 avg_scaling: " << avg_scaling << ", avg_sq_scaling: " << avg_sq_scaling << ", new_avg_scaling: " << new_avg_scaling << ", new_avg_sq_scaling: " << new_avg_sq_scaling << std::endl;
    // std::cout << "half_precision_param: " << half_precision_param << ", half_precision_opt_state: " << half_precision_opt_state << std::endl;
    ...
    // std::cout << "Step 4 [AVX] -> ret: " << ret.first << ", " << ret.second << std::endl;
    ...
    // std::cout << "Step 4 [Final] -> ret: " << ret.first << ", " << ret.second << std::endl;
    return ret;
}
                            ...
                            float new_avg_sq_scaling)
{
    size_t rounded_size = 0;
    std::pair<float, float> ret = std::make_pair(0.0f, 0.0f);
    // std::cout << "Step 8 -> avg_scaling: " << avg_scaling << ", avg_sq_scaling: " << avg_sq_scaling << ", new_avg_scaling: " << new_avg_scaling << ", new_avg_sq_scaling: " << new_avg_sq_scaling << std::endl;
    // std::cout << "half_precision_param: " << half_precision_param << ", half_precision_opt_state: " << half_precision_opt_state << std::endl;
    ...
    // std::cout << "Step 8 -> ret: " << ret.first << ", " << ret.second << std::endl;
    return ret;
}
                 ...
                 float new_avg_sq_scaling)
{
    ...
    // std::cout << "avg_scaling: " << avg_scaling << ", avg_sq_scaling: " << avg_sq_scaling << ", new_avg_scaling: " << new_avg_scaling << ", new_avg_sq_scaling: " << new_avg_sq_scaling << std::endl;
    // std::cout << "half_precision_param " << half_precision_param << ", half_precision_opt_state " << half_precision_opt_state << std::endl;
